...
function AdminCollection() {
    ...
    const updateTableAfterEdition = (id, index) => {
        ...
        axios.put(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/collections/edit/${id}`, myObj)
        .then((response) => {
            console.log('Success:', response);
        })
        .catch((error) => {
    ...
    const updateTableAfterDeletion =  (id, index) => {
        ...
        axios.delete(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/collections/delete/${id}`)
        .then((response) => {
            console.log('Success:', response);
        })
        .catch((error) => {
