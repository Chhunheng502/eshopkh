...
function AdminProduct() {
    ...
    const updateTableAfterDeletion =  (id) => {
        ...
        axios.delete(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/products/delete/${id}`)
        .then((response) => {
            console.log('Success:', response);
        })
        .catch((error) => {
    ...
    const updateTableAfterEdition = (id, index) => {
        ...
        axios.put(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/products/edit/${id}`, myObj)
        .then((response) => {
            console.log('Success:', response);
        })
        .catch((error) => {
    ...
    const handleAddToCollection = () => {
        ...
        axios.post(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/collections/add-products/${collectionRef.current.value}`, myObj)
        .then((response) => {
            console.log('Success:', response);
        })
        .catch((error) => {
