...
function CheckOut(props) {
    ...
    const handleCheckout = async (event) => {
        ...
        axios.post('https://eshopkh-server-4xrg3.ondigitalocean.app/api/orders/store',  dataObj)
        .then((response) => {
        ...
        axios.post(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/users/promo/delete/${Number(sessionStorage.getItem("user-id"))}`, {promo_code: setOfCodes})
        .then((response) => {
            console.log('Success:', response);
        })
        .catch((error) => {
    ...
    const handleRedeemCode = (event) => {
        ...
        axios.post(`https://eshopkh-server-4xrg3.ondigitalocean.app/api/users/promo/redeem/${Number(sessionStorage.getItem("user-id"))}`, {promo_code: codeRef.current.value})
        .then((response) => {
