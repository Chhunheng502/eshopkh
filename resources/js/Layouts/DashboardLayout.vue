...
@icon-url-overview: "https://icongr.am/entypo/home.svg?size=128&color=ffffff";
@icon-url-order: "https://icongr.am/entypo/list.svg?size=128&color=ffffff";
@icon-url-contact: "https://icongr.am/entypo/users.svg?size=128&color=ffffff";
@icon-url-inventory: "https://icongr.am/entypo/dropbox.svg?size=128&color=ffffff";
...
.menu{
	...
	ul{
		...
		li{
			...
			&.icon-overview{
				background-image:url(@icon-url-overview);
			}
			&.icon-order{
				background-image:url(@icon-url-order);
			}
			&.icon-contact{
				background-image:url(@icon-url-contact);
			}
			&.icon-inventory{
				background-image:url(@icon-url-inventory);
			}
            &.icon-collection{
				background-image:url(@icon-url-collection);
			}
			&.icon-report{
				background-image:url(@icon-url-report);
			}
